<template>
  <div class="uk-card uk-card-default">
    <div class="uk-card-body">
      ...
      <div
        class="uk-margin uk-grid-small uk-child-width-1-1 uk-child-width-1-2@m"
        uk-grid
      >
        <div>
          <label>Device Type</label>
          <div class="uk-child-width-1-4 uk-grid-small uk-grid-match" uk-grid>
            <div v-for="device of device_types" :key="device.id">
              <div
                class="uk-padding-small uk-text-large uk-card-default uk-text-center"
                :uk-tooltip="'title:' + device.name"
              >
                <font-awesome-icon :icon="'fas fa-' + device.icon" />
              </div>
            </div>
            <div>
              <div
